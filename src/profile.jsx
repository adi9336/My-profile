...
import './profile.css'; // Assuming you've moved the CSS to a separate file
    ...
    <div className="wrapper">
      ...
      <div className={`profile-card js-profile-card ${isActive ? 'active' : ''}`}>
        <div className="profile-card__img">
          <img src="aditya.png" alt="profile" />
        </div>

        <div className="profile-card__cnt js-profile-cnt">
          <div className="profile-card__name">Aditya Gupta</div>
          <div className="profile-card__txt">
            Front-end Developer from <strong>Delhi</strong>
          </div>
          <div className="profile-card-loc">
            ...
            <span className="profile-card-loc__txt">Delhi , India</span>
          </div>

          <div className="profile-card-inf">
            <div className="profile-card-inf__item">
              <div className="profile-card-inf__title">351</div>
              <div className="profile-card-inf__txt">Followers</div>
            </div>

            <div className="profile-card-inf__item">
              <div className="profile-card-inf__title">650</div>
          ...
          <div className="profile-card-social">
            <a
              href="https://www.facebook.com/profile.php?id=100011990281987"
            ...
            <a
              href="https://www.instagram.com/aditya__9336/"
            ...
            <a
              href="https://www.linkedin.com/in/aditya-gupta-7a0546203/"
          ...
          <div className="profile-card-ctr">
            <button className="profile-card__button button--blue js-message-btn" onClick={handleMessageClick}>
              Message
            </button>
          </div>
        </div>
        ...
        <div className="profile-card-message js-message">
          <form className="profile-card-form">
            <div style={{marginBottom: '20px', marginTop: '-30px', display: 'flex', alignItems: 'center', justifyContent: 'center'}} className="profile-card-form__container">
              <textarea placeholder="Say something...">hey</textarea>
            </div>

            <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}} className="profile-card-form__bottom">
              <button className="profile-card__button button--blue js-message-close" onClick={handleCloseClick}>
                Send
              </button>
            </div>
          </form>

          <div className="profile-card__overlay js-message-close" onClick={handleCloseClick}></div>
        </div>
      </div>
    </div>
